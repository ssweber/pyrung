...
PAGES: tuple[ReferencePage, ...] = (
    ...
    ReferencePage(
        ...
        symbols=(
            ...
            "pyrung.rung",
            "pyrung.program",
            "pyrung.PyrungNameError",
            "pyrung.PyrungNameWarning",
            "pyrung.branch",
            "pyrung.comment",
            "pyrung.forloop",
            "pyrung.subroutine",
