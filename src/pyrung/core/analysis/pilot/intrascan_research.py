"""Research exact intrascan boundaries on disposable counterfactual executions.

This module owns detached boundary, producer-goal, and traceback evidence plus
the disposable execution used to discover it. It does not interpret accepted
execution observations, admit active requirements, or mutate Pilot state.
"""
