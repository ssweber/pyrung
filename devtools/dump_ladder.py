...
from pyrung.click import TagMap, c, ct, ctd, x, y
...
_dump("Case 1: A,B,C,D + branch(E) + branch(F)", mapping.to_ladder(logic))
...
mapping = TagMap({**base_map}, include_system=False)
_dump("Case 2: A,B,C + branch(D,E)", mapping.to_ladder(logic))
...
mapping = TagMap({**base_map}, include_system=False)
_dump("Case 3: A + branch(B) + branch(C) + branch(D)", mapping.to_ladder(logic))
...
mapping = TagMap({**base_map}, include_system=False)
_dump("Case 4: A out+latch + branch(Mode)", mapping.to_ladder(logic))
...
mapping = TagMap({**base_map}, include_system=False)
_dump("Case 5: A,B out branch out branch", mapping.to_ladder(logic))
...
mapping = TagMap({**base_map}, include_system=False)
_dump("Case 6: all_of(A, any_of(B,C), D)", mapping.to_ladder(logic))
...
mapping = TagMap({**base_map}, include_system=False)
_dump("Case 7: any_of(all_of(A,B), all_of(C,D))", mapping.to_ladder(logic))
...
mapping = TagMap({**base_map}, include_system=False)
_dump("Case 8: any_of(A, B, C, all_of(D,E,F))", mapping.to_ladder(logic))
...
mapping = TagMap({**base_map}, include_system=False)
_dump("Case 9: A,B,C,D,any_of(E,F,G)", mapping.to_ladder(logic))
...
mapping = TagMap({**base_map}, include_system=False)
_dump("Case 10: any_of(any_of(A,B), any_of(C,D))", mapping.to_ladder(logic))
...
mapping = TagMap({**base_map}, include_system=False)
_dump("Case 11: A, any_of(~B, C, ~D)", mapping.to_ladder(logic))
...
_dump("Case 12: A,B out + branch(Mode) count_up.reset", mapping.to_ladder(logic))
...
mapping = TagMap({**base_map}, include_system=False)
_dump("Case 13: any_of(A, all_of(B,C,D))", mapping.to_ladder(logic))
...
mapping = TagMap({**base_map}, include_system=False)
_dump("Case 14: any_of(A,B), E, any_of(C,D), F", mapping.to_ladder(logic))
...
mapping = TagMap({**base_map}, include_system=False)
_dump("Case 15: any_of(A,B) + out + branch(Mode)", mapping.to_ladder(logic))
...
mapping = TagMap({**base_map}, include_system=False)
_dump("Case 16: any_of(A,B,C) + out + branch(Mode)", mapping.to_ladder(logic))
...
mapping = TagMap({**base_map}, include_system=False)
_dump("Case 17: any_of(A,B) + out + branch(M1) + branch(M2)", mapping.to_ladder(logic))
...
mapping = TagMap({**base_map}, include_system=False)
_dump("Case 18: any_of(A,B) + out + branch(Mode) + out", mapping.to_ladder(logic))
...
mapping = TagMap({**base_map}, include_system=False)
_dump("Case 19: any_of(A,B) + branch(M1) + branch(M2) [no leading out]", mapping.to_ladder(logic))
