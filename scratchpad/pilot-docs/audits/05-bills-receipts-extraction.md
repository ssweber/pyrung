...
| (proof blocking) | — | — | — | `pilot.py:3892-3914` withholds theory proof while any requirement ACTIVE — optional recording only | undischargeable requirement permanently blocks theory proof |
