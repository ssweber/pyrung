...
class TestStripPyrungBoilerplate:
    def test_removes_imports_and_header(self):
        code = (
        ...
        assert result.startswith('C1 = Bool("C1")')
        assert "from pyrung" not in result
    ...
    def test_raises_on_missing_program(self):
        ...
        with pytest.raises(ValueError, match="No body found"):
